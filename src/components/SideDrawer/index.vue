        ...
        <el-drawer
            ...
            <div style="padding-left: 2em">
                <el-row>
                    <el-col :span="12">
                        <h5>Movie genres</h5>
                        <el-select v-model="selectedMovieGenres" multiple filterable :collapse-tags="true" placeholder="Genres"
                    ...
                    <el-col :span="12">
                        <h5>Series genres</h5>
                        <el-select v-model="selectedSeriesGenres" multiple filterable :collapse-tags="true" placeholder="Genres"
                            :no-match-text="'No Results'" value-key="id" class="full-width" clearable
                            @change="updateStore()">
                            <el-option
                                v-for="item in seriesGenres"
                                :key="item.id"
                                :label="item.name"
                                :value="item">
                            </el-option>
