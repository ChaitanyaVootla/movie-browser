    ...
    <>
      ...
      <style jsx global>{`
        ...
        @keyframes fire-particle-2 {
          ...
          25% { transform: translateY(-6px) scaleY(1.4); opacity: 1; }
          75% { transform: translateY(-2px) scaleY(1.1); opacity: 0.7; }
        }
        @keyframes fire-particle-3 {
          0%, 100% { transform: translateY(0) scaleY(1); opacity: 0.7; }
          50% { transform: translateY(-5px) scaleY(1.2); opacity: 1; }
        }
        @keyframes ember-1 {
        ...
        /* Animation classes */
        .animate-fire-glow { animation: fire-glow 0.8s ease-in-out infinite; }
        .animate-fire-particle-1 { animation: fire-particle-1 0.6s ease-in-out infinite; }
        .animate-fire-particle-2 { animation: fire-particle-2 0.5s ease-in-out infinite; }
        .animate-fire-particle-3 { animation: fire-particle-3 0.7s ease-in-out infinite; }
        .animate-ember-1 { animation: ember-1 1.2s ease-out infinite; }
        .animate-ember-2 { animation: ember-2 1.5s ease-out infinite 0.3s; }
        ...
        .animate-twinkle-2 { animation: twinkle-2 2s ease-in-out infinite 0.5s; }
        .animate-twinkle-3 { animation: twinkle-3 1.8s ease-in-out infinite 1s; }
