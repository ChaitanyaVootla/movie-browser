...
/**
 * Person Page Error Boundary
 *
 * Catches errors that occur when loading/rendering a person page.
...
export default function PersonError({ error, reset }: ErrorProps) {
  useEffect(() => {
    ...
    console.error("[PersonError] Caught error:", error);
  ...
  return (
    ...
    >
      <div className="w-full max-w-md text-center">
        ...
        {/* Error message */}
        <h1 className="text-xl font-bold mb-2">Couldn&apos;t load profile</h1>
        <p className="text-muted-foreground mb-6">
          We had trouble loading this person&apos;s profile. It might be temporarily unavailable.
        </p>
        ...
        <div className="mt-6 pt-6 border-t border-border">
          <p className="text-sm text-muted-foreground mb-3">Looking for someone else?</p>
