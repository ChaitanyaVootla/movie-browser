...
const WIKIDATA_MOVIE_PROPERTIES: Record<
  string,
  { name: string; urlPattern?: string; priority: "high" | "medium" | "low"; notes: string }
> = {
  ...
  P345: {
    ...
    priority: "high",
    notes: "Plot, trivia, goofs, quotes, connections",
  },
  P1258: {
    name: "Rotten Tomatoes ID",
    urlPattern: "https://www.rottentomatoes.com/{id}",
    priority: "high",
    notes: "Critic consensus, reviews, scores",
  },
  P1712: {
    name: "Metacritic ID",
    urlPattern: "https://www.metacritic.com/{id}",
    priority: "high",
    notes: "Aggregated critic scores",
  },
  P6127: {
    name: "Letterboxd ID",
    urlPattern: "https://letterboxd.com/film/{id}",
    priority: "high",
    notes: "User reviews, themes, lists",
  },
  P4947: {
    name: "TMDb movie ID",
    urlPattern: "https://www.themoviedb.org/movie/{id}",
    priority: "high",
    notes: "Primary source - already using",
  },
  P4835: {
    name: "TV Tropes ID",
    urlPattern: "https://tvtropes.org/pmwiki/pmwiki.php/{id}",
    priority: "high",
    notes: "Tropes! Needs Playwright",
  },
  P6839: {
    name: "TV Tropes ID (article)",
    urlPattern: "https://tvtropes.org/pmwiki/pmwiki.php/{id}",
    priority: "high",
    notes: "Direct TV Tropes page",
  },
  P8084: {
    name: "Fandom wiki ID",
    urlPattern: "https://{id}.fandom.com",
    priority: "high",
    notes: "Detailed content for popular franchises",
  },
  P6262: {
    name: "Fandom article ID",
    urlPattern: "https://{id}",
    priority: "medium",
    notes: "Direct article link",
  },
  P2219: {
    name: "AllMovie ID",
    urlPattern: "https://www.allmovie.com/movie/{id}",
    priority: "high",
    notes: "Moods, themes, tones - PERFECT for labels!",
  },

  // Medium priority - Additional useful sources
  P1874: {
    name: "Netflix ID",
    urlPattern: "https://www.netflix.com/title/{id}",
    priority: "medium",
    notes: "Watch availability",
  },
  P8055: {
    name: "Prime Video ID",
    urlPattern: "https://www.amazon.com/dp/{id}",
    priority: "medium",
    notes: "Watch availability",
  },
  P9586: {
    name: "Apple TV+ ID",
    urlPattern: "https://tv.apple.com/movie/{id}",
    priority: "medium",
    notes: "Watch availability",
  },
  P11460: {
    name: "Disney+ ID",
    urlPattern: "https://www.disneyplus.com/movies/{id}",
    priority: "medium",
    notes: "Watch availability",
  },
  ...
  P5765: {
    name: "Box Office Mojo ID",
    urlPattern: "https://www.boxofficemojo.com/movies/?id={id}",
    priority: "medium",
    notes: "Box office data",
  },
  P2219: {
    name: "AllMovie ID",
    urlPattern: "https://www.allmovie.com/movie/{id}",
    priority: "medium",
    notes: "Themes, moods, tones!",
  },
  P4634: {
    name: "AFI Catalog ID",
    urlPattern: "https://catalog.afi.com/Film/{id}",
    priority: "medium",
    notes: "American classics",
  },
  P1265: {
    name: "AlloCiné ID",
    urlPattern: "https://www.allocine.fr/film/fichefilm_gen_cfilm={id}.html",
    priority: "medium",
    notes: "French reviews",
  },
  P1804: { name: "DNB ID", priority: "low", notes: "German National Library" },
  P2603: {
    name: "Kinopoisk ID",
    urlPattern: "https://www.kinopoisk.ru/film/{id}",
    priority: "medium",
    notes: "Russian reviews",
  },
  P2529: {
    name: "ČSFD ID",
    urlPattern: "https://www.csfd.cz/film/{id}",
    priority: "low",
    notes: "Czech film database",
  },
  P2631: {
    name: "Filmweb ID",
    urlPattern: "https://www.filmweb.pl/film/{id}",
    priority: "low",
    notes: "Polish film database",
  },
  ...
  P2509: {
    name: "MovieMeter ID",
    urlPattern: "https://www.moviemeter.nl/film/{id}",
    priority: "low",
    notes: "Dutch film database",
  },
  P2435: { name: "PORT.hu ID", priority: "low", notes: "Hungarian database" },
  P2639: {
    name: "FilmAffinity ID",
    urlPattern: "https://www.filmaffinity.com/en/film{id}.html",
    priority: "medium",
    notes: "Spanish reviews",
  },
  ...
  P5990: {
    name: "Movie Review Query ID",
    urlPattern: "https://moviereviewquery.com/film/{id}",
    priority: "medium",
    notes: "Critic reviews aggregator",
  },
  P8013: {
    name: "Trakt.tv ID",
    urlPattern: "https://trakt.tv/{id}",
    priority: "medium",
    notes: "Watch tracking, user ratings",
  },
  P7285: {
    name: "Douban ID",
    urlPattern: "https://movie.douban.com/subject/{id}",
    priority: "medium",
    notes: "Chinese reviews/ratings",
  },
  P905: {
    name: "Filmportal ID",
    urlPattern: "https://www.filmportal.de/film/{id}",
    priority: "low",
    notes: "German film database",
  },
  P480: {
    name: "FilmAffinity ID",
    urlPattern: "https://www.filmaffinity.com/en/film{id}.html",
  ...
  P7975: {
    name: "Simkl ID",
    urlPattern: "https://simkl.com/movies/{id}",
    priority: "low",
    notes: "Watch tracking",
  },
  P444: {
    name: "Review score",
    priority: "medium",
    notes: "Aggregated review score (e.g., 79/100)",
  },
...
async function analyzeMovie(tmdbId: number) {
  ...
  const byPriority: Record<
    string,
    Array<{ prop: string; name: string; value: string; url?: string; notes: string }>
  > = {
    high: [],
    medium: [],
    low: [],
  ...
  for (const priority of ["high", "medium", "low", "unknown"]) {
    ...
    for (const item of items) {
      console.log(
        `${item.prop.padEnd(8)} ${item.name.padEnd(30)} ${item.value.slice(0, 30).padEnd(32)}`
      );
      if (item.url) {
