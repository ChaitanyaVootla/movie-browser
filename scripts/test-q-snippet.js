...
var region = process.env.BEDROCK_REGION || "ap-south-1";
function testRawSDK() {
      ...
      switch (_c.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            client.send(
              new client_bedrock_runtime_1.ConverseCommand({
                modelId: modelId,
                messages: [
                  {
                    content: [{ text: "say hi" }],
        ...
        case 1:
          response = _c.sent();
          content =
            (_b = (_a = response.output) === null || _a === void 0 ? void 0 : _a.message) ===
              null || _b === void 0
              ? void 0
              : _b.content;
          textBlock =
