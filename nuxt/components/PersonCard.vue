    ...
    <div class="card group cursor-pointer pt-2 flex flex-col">
      <div class="relative">
        <SeoImg
          ...
          class="image rounded-full hover:shadow-md hover:shadow-neutral-800 hover:transition-all duration-300 hover:mb-1 md:hover:-mt-1 border-2 border-transparent hover:border-neutral-800 border-neutral-800 w-full h-full"
          :timeout="4000"
        >
