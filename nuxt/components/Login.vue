<template>
  <v-dialog
    ...
    class="login-modal"
  >
    <v-card title="Login" class="login-modal-card" rounded="lg" elevation="8">
      <v-card-text class="text-center py-6"> Please login to complete this action </v-card-text>
      ...
      <v-card-actions class="pt-0 pb-4 justify-center">
        <v-btn variant="text" color="grey" @click="closeDialog" class="text-sm"> Not now </v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
</template>
