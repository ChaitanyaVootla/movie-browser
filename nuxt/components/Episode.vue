  ...
  <div class="episode-container">
    <div class="episode-content">
      ...
      <div class="episode-header">
        <div class="episode-title">Season {{ episode.season_number }} - {{ episode.name }}</div>
        <div class="episode-overview" v-if="episode.overview">
          {{ episode.overview }}
        </div>
        <div class="episode-meta" v-if="episode.air_date">
          <NuxtTime
            :datetime="new Date(episode.air_date)"
            year="numeric"
            month="long"
            day="numeric"
          />
      ...
      <div
        class="episode-carousel-container"
        v-if="fullEpisode?.images?.stills?.length || episode.still_path"
      >
        <v-carousel
          color="white"
          :cycle="false"
          ...
          >
            <div class="episode-image-container">
              ...
              >
                ...
                <template #error>
                  <div
                    class="episode-image bg-neutral-700 rounded-lg flex items-center justify-center"
                  >
...
const fullEpisode = await $fetch(
  `/api/series/${episode.show_id}/season/${episode.season_number}/episode/${episode.episode_number}`
);
</script>
