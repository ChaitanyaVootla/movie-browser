<template>
  <div
    class="mx-14 flex items-center gap-4 w-fit rounded-xl border-2 border-neutral-600 my-6 pl-3 overflow-hidden"
  >
    <div class="font-medium">
      {{ topicMeta.name }}
    </div>
    <div
      class="text-sm font-medium rounded-r-xl bg-neutral-800 w-fit h-full px-3 flex items-center py-1 text-neutral-3"
    >
      TOPIC
    </div>
  </div>
  ...
  <ScrollProvider
    v-for="scrollItem in topicScrollVariations"
