  ...
  <div class="md:px-14">
    <div class="top-action flex max-md:justify-center mt-4 mb-5 gap-4">
      ...
      <v-btn-toggle
        ...
        mandatory
        density="compact"
        @update:model-value="ratingTypeUpdated"
      >
        <v-btn size="default"> Dislikes </v-btn>
        <v-btn size="default"> Likes </v-btn>
      </v-btn-toggle>
    </div>
...
const { data: ratingsData, refresh: refreshRatings } = await useLazyAsyncData(
  "userRatings",
  () => {
