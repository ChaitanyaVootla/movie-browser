...
describe("SEO Utils", () => {
  ...
  describe("URL Validation", () => {
    ...
    it("should validate slug format", () => {
      const validSlugs = ["fight-club", "game-of-thrones", "brad-pitt", "the-dark-knight"];
  ...
  describe("Meta Tag Validation", () => {
    ...
    it("should validate description length constraints", () => {
      const validDescription =
        "This is a valid meta description that provides useful information about the page content and is within the recommended length limits.";
      ...
      expect(validDescription.length).toBeGreaterThanOrEqual(
        performanceThresholds.descriptionLength.min
      );
      expect(validDescription.length).toBeLessThanOrEqual(
        performanceThresholds.descriptionLength.max
      );
